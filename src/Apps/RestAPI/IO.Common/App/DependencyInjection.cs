...
public static class DependencyInjection
{
    ...
    private static IHostApplicationBuilder ConfigureMonitoring(this IHostApplicationBuilder builder)
    {
        ...
        var group = builder.Configuration[ApplicationOptions.Group] ?? "common";
    ...
    private static IHostApplicationBuilder AddSwagger(this IHostApplicationBuilder builder)
    {
        ...
        {
            document.DocumentName = "io-common-api-v1";
            document.Title = "IO Common API v1";
            document.Description = "Common API for IO platform - Version 1.0";
            document.ApiGroupNames = ["Email"];

...
var group = configuration.GetValue<string>(EnvironmentVariables.ApplicationGroup) ?? "elsa";
...
builder.AddMongoDb()
       .AddRateCardRepository();

// Add HTTP clients for external APIs
builder.Services.AddHttpClient<ElsaPricingApiClient>();
...
// Map static routes
app.MapPricingRoutes();

// Add API info endpoint
app.AddApiInfo("IO Elsa API", "Pricing and load cost calculations");

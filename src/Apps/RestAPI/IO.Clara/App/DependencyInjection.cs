...
public static class DependencyInjection
{
    ...
    private static IHostApplicationBuilder ConfigureMonitoring(this IHostApplicationBuilder builder)
    {
        ...
        var group = builder.Configuration[ApplicationOptions.Group] ?? "clara";
    ...
    private static IHostApplicationBuilder AddSwagger(this IHostApplicationBuilder builder)
    {
        ...
        {
            document.DocumentName = "io-clara-api-v1";
            document.Title = "IO Clara API v1";
            document.Description = "Clara Carrier Validation API for IO platform - Version 1.0";
            document.ApiGroupNames = ["Clara"];

...
from .models import request, response, pricing
...
def lookup_price(item: request.Request) -> response.Response:
    price_body = pricing.PriceRequest()
    try:
        ...
        return response.Response(jobs=jobs)
